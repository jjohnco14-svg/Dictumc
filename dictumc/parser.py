...
class Parser:
    ...
    _PRIMITIVE_SUFFIXES = {
        ...
        'truth':      ['value'],
        'fractional': ['number'],
        'decimal':    ['number'],   # BUG-06
    }
    # Terminal single words
    _TERMINAL_TYPES = {'byte', 'text', 'bytes', 'count', 'nothing',
                        'u8', 'u16', 'u32', 'i32', 'i64', 'u64', 'bool',
                        'result'}
    ...
    def parse_prefix_expression(self) -> Node:
        ...
        if nxt == 'sum':         return _two('+')
            ...
            if op_word == 'not': return UnaryOp(op='~', operand=a, line=line)
    ...
    def parse_import_c(self, line: int) -> ImportC:
        ...
        params = []
        while not self.match_word('produces'):
