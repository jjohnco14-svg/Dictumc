...
class DictumGrammar:
    ...
    KEYWORDS = {
        ...
        'is','equal','to','not','greater','less','or','at','least','most','empty',
    ...
    TYPE_WORDS = {
        'whole','number','count','fractional','truth','value',
        'byte','text','handle','to','bytes','u16','u32','i32','i64',
        'decimal',   # BUG-06
    }
    ...
    def _init_valid_tokens(cls) -> None:
        ...
        cls._VALID_TOKENS = {
            ...
            GrammarState.BLOCK_BODY: frozenset({
                ...
                'defer','release','shape','action','import','end',
            ...
            GrammarState.COMPARISON: frozenset({
                'equal','not','greater','less','or','at','empty',
    ...
    def feed_token(self, token_text: str, token_type: str = "WORD",
        ...
        EXPR_CONTINUATORS = {
            ...
            'is','equal','to','not','greater','less','or','at','least','most',
        ...
        if state == GrammarState.COMPARISON:
            ...
            if token_text in ('equal','not','greater','less','or','at','empty'): return True
